...
public class PatientDashboardController implements Initializable {
    ...
    private void handleConsignes() {
        ...
        loadPage("/tn/esprit/ressources/patient/Consignes.fxml");
    }

    @FXML
    private void handleOrdonnances() {
        setActiveButton(btnConsignes); // ou un nouveau bouton si tu préfères
        loadPage("/tn/esprit/ressources/patient/Ordonnances.fxml");
    }
