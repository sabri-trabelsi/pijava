...
public class MainFX extends Application {
    ...
    public class MainTestConsignes extends Application {
        @Override
        public void start(Stage primaryStage) throws Exception {
            Parent root = FXMLLoader.load(getClass().getResource("/tn/esprit/ressources/doctor/Consignes.fxml"));
            Scene scene = new Scene(root);
            primaryStage.setTitle("Test Consignes - Médecin");
            primaryStage.setScene(scene);
            primaryStage.show();
        }
